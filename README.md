...
## Stats (v6.0.0)  <!-- __s323_readme_version_current_v1__ -->

| Metric | Value |
|---|---|
| Tests | 3370 passing, floor 3369 (PYTEST_FLOOR enforced) |
...
See [CHANGELOG.md](CHANGELOG.md). Latest release: [v6.0.0](https://github.com/contrario/nous/releases/tag/v6.0.0).  <!-- __s323_readme_version_current_v1__ -->
