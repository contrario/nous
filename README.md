...
- [Decision Ledger](docs/DECISION_LEDGER.md) -- a presentation view over a signed trace's recorded decisions (approve/deny/override distribution, principal diversity, time spread) for an auditor's own rubber-stamping test; presents the distribution, does NOT verify signatures, prove any decision correct or authorized, score meaningfulness, or gate a verdict -- run `nous verify` for the cryptographic proof  <!-- __s152_u3_decision_ledger_readme_xref_v1__ -->
