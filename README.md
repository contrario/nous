...
## Stats (v5.80.1)  <!-- __s323_readme_version_current_v1__ -->

| Metric | Value |
|---|---|
| Tests | 2959 passing, floor 2958 (PYTEST_FLOOR enforced) |
...
See [CHANGELOG.md](CHANGELOG.md). Latest release: [v5.80.1](https://github.com/contrario/nous/releases/tag/v5.80.1).  <!-- __s323_readme_version_current_v1__ -->
