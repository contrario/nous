...
## Stats (v5.79.0)  <!-- __s323_readme_version_current_v1__ -->

| Metric | Value |
|---|---|
| Tests | 2908 passing, floor 2907 (PYTEST_FLOOR enforced) |
...
See [CHANGELOG.md](CHANGELOG.md). Latest release: [v5.79.0](https://github.com/contrario/nous/releases/tag/v5.79.0).  <!-- __s323_readme_version_current_v1__ -->
