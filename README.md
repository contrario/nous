...
## Stats (v5.84.0)  <!-- __s323_readme_version_current_v1__ -->

| Metric | Value |
|---|---|
| Tests | 3096 passing, floor 3095 (PYTEST_FLOOR enforced) |
...
See [CHANGELOG.md](CHANGELOG.md). Latest release: [v5.84.0](https://github.com/contrario/nous/releases/tag/v5.84.0).  <!-- __s323_readme_version_current_v1__ -->
