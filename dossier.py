...
def build_dossier(
    ...
    *,
    ...
    if _prior_digest is not None and coverage_farkas_bytes is not None \
        ...
        raise DossierError(
            ...
            "checks single-system certificates only; a re-binding dossier "
            "over a boolean blocking net must currently rely on the z3 "
            "path (S124 carry-forward)"
        )
